...
router.get("/clientes/notas/:id",(req: Request, res: Response) => {clienteController.listaNotasCliente(req,res)})
...
router.get("/vendedores/notas/:id",(req: Request, res: Response) => {vendedorController.listaNotasVendedor(req,res)})
