...
export class CarroService {
    ...
    async insereCarro(carroBody: any): Promise<Carro> {
        ...
        const novoCarro = new Carro(null, carroBody.marca,carroBody.modelo,carroBody.ano,carroBody.placa,carroBody.preco,carroBody.cor)
    
        return this.carroRepository.insereCarro(novoCarro)
    }
